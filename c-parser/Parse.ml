...
let children_regexps : (string * Run.exp option) list = [
  ...
  Some (
    Alt [|
      ...
      Token (Name "function_declaration_declarator");
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2; v3] ->
          (
            ...
            (match v1 with
            | Alt (0, v) ->
                `Opt_ms_call_modi_decl_decl_opt_gnu_asm_exp (
                  (match v with
                  | Seq [v0; v1; v2] ->
                      (
                        Run.opt
...
and trans_declaration_declarator ((kind, body) : mt) : CST.declaration_declarator =
  ...
  | Children v ->
      ...
      | Alt (2, v) ->
          `Func_decl_decl (
            trans_function_declaration_declarator (Run.matcher_token v)
          )
      | Alt (3, v) ->
          `Array_decl (
...
and trans_function_declaration_declarator ((kind, body) : mt) : CST.function_declaration_declarator =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
          ...
          (
            ...
            Run.opt
              (fun v ->
                ...
                | Alt (1, v) ->
                    `Prep_elif_in_enum_list_1680e39 (
                      trans_preproc_elif_in_enumerator_list (Run.matcher_token v)
                    )
                | Alt (2, v) ->
                    `Prep_elif_in_enum_list_8fab4d0 (
          ...
          (
            ...
            Run.opt
              (fun v ->
                ...
                | Alt (1, v) ->
                    `Prep_elif_in_enum_list_no_comma_0776021 (
                      trans_preproc_elif_in_enumerator_list_no_comma (Run.matcher_token v)
                    )
                | Alt (2, v) ->
                    `Prep_elif_in_enum_list_no_comma_b3ccc22 (
